...
def settlement_balance(
    ...
    if ask_overwrite:
        ...
        if amount_str != "":
            try:
                ...
                print_warning("⚠️ Ups", "Input overwrite ngaco, pake harga asli aja 🚨")
    ...
    if payment_res.get("status") != "SUCCESS":
        print_error("⚠️ Ups", "Gagal ambil payment methods bro 🚨")
